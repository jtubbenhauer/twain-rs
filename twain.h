...
/* ======================================================================== *\
  ...
  Revision History:
    ...
    version 1.8  March 1999      Removed undocumented 1.8 caps:
                               ...
                               * CAP_PAGEMULTIPLEACQUIRE - is
CAP_REACQUIREALLOWED, requires spec change.  JMH Added Mac structure packing
modifications JMH version 1.9  March 2000  Added new types and definations
required for 1.9 Specification MLM version 1.9  March 2000  Added
ICAP_JPEGQUALITY, TWJQ_ values, updated TWON_PROTOCOLMINOR for Release v1.9 MN
    ...
    version 2.0  Mar 2008        Depreciated ICAP_PIXELTYPEs TWPT_SRGB64,
TWPT_BGR, TWPT_CIELAB, TWPT_CIELUV, and TWPT_YCBCR  JMW version 2.0  Mar 2008
Added missing new 2.0 CAP_ definitions JMW version 2.0  Dec 2008        Updated
TW_INFO structure for 64bit JMW version 2.1  Mar 2009        Added new types and
definitions required for 2.1 Specification JMW version 2.2  Nov 2010 Added new
types and definitions required for 2.2 Specification MSM version 2.3  Feb 2013
Added new types and definitions required for 2.3 Specification MLM version 2.3a
Apr 2015        Errata fixes to TWCY_ANDORRA and TWCY_CUBA version 2.4  Aug 2015
Added new types and definitions required for 2.4 Specification MLM version 2.4a
June 2016       Added TW_INT32 and TW_UINT32 fixes for Linux, (I just added this
comment today) version 2.4b March 2017      Missing changeset from 2.3 verion
(2013/06/20) version 2.5  Jan 2021        Added new types and definitions
required for 2.5 Specification MLM
...
/* Defines the mapping from an RGB color space device into CIE 1931 (XYZ) color
 * space. */
typedef struct {
...
/* This structure is used by the application to specify a set of mapping values
 * to be applied to grayscale data. */
typedef struct {
...
/* This structure is used by the application to specify a set of mapping values
 * to be applied to RGB color data. */
typedef struct {
  TW_ELEMENT8 Response[1];
...
/* This structure is used to handle the user interface coordination between an
...
TW_UINT16 TW_CALLINGSTYLE DSM_Entry(pTW_IDENTITY pOrigin, pTW_IDENTITY pDest,
...
TW_UINT16 TW_CALLINGSTYLE DS_Entry(pTW_IDENTITY pOrigin, TW_UINT32 DG,
...
TW_UINT16 TW_CALLINGSTYLE TWAIN_Callback(pTW_IDENTITY pOrigin,
                                         ...
                                         TW_UINT16 DAT, TW_UINT16 MSG,
                                         TW_MEMREF pData);
typedef TW_UINT16(TW_CALLINGSTYLE *TWAINCALLBACKPROC)(
    pTW_IDENTITY pOrigin, pTW_IDENTITY pDest, TW_UINT32 DG, TW_UINT16 DAT,
...
/* Restore the previous packing alignment: this occurs after all structures are
 * defined */
#ifdef TWH_CMP_MSC
